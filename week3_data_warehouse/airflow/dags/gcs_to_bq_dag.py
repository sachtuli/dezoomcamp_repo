...
DATASET = "tripdata"
COLOUR_RANGE = {'yellow': 'tpep_pickup_datetime'}  #, 'green': 'lpep_pickup_datetime' ,'yellow': 'tpep_pickup_datetime'
INPUT_PART = "raw"
...
with DAG(
    ...
    for colour, part_col in COLOUR_RANGE.items():
        # move_files_gcs_task = GCSToGCSOperator(
        #     task_id=f'move_{colour}_{DATASET}_files_task',
        #     source_bucket=BUCKET,
        #     source_object=f'{INPUT_PART}/{colour}_{DATASET}*{parquet_file}',
